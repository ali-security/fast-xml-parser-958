...
this.addChild=function(child){if(child.tagname==="__proto__")child.tagname="#__proto__";if(Array.isArray(this.child[child.tagname])){//already presents
